    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-base md:text-lg font-semibold" style={{ color: "var(--text-primary)" }}>
          Thông tin vị trí khảo sát
        </span>
      </div>

      {/* Grid 3 cột trên Tablet/Desktop */}
            ...
            {BUILDINGS.map((b) => {
              ...
              return (
                <button
                  ...
                  className="px-3.5 py-2 rounded-full text-xs md:text-sm font-medium border transition-all active:scale-95 cursor-pointer"
                  style={{
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="w-full rounded-xl px-4 py-3 text-sm font-medium appearance-none border outline-none transition-all focus:ring-2 cursor-pointer"
              style={{
